...
help:
	...
	@echo "make setup_models"
	@echo "       start database container and train models"
	@echo "make process_all"
	@echo "       start database container and call CBS API, process parquet files and train the models that are used for predictions. Use optional argument 'NUM_PROCESSES=' to set the number of processes"
	@echo "make test"
	@echo "       run pytest"
	@echo "make format"
	@echo "       run black"
